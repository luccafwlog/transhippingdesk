...
install_skill 'caveman' "$(cat << 'SKILLEOF'
---
name: caveman
description: >
...
install_skill 'frontend-design' "$(cat << 'SKILLEOF'
---
...
install_skill 'grill-me' "$(cat << 'SKILLEOF'
---
name: grill-me
...
install_skill 'grill-me-with-docs' "$(cat << 'SKILLEOF'
---
...
install_skill 'handoff' "$(cat << 'SKILLEOF'
---
name: handoff
...
install_skill 'security-audit-penetration-testing' "$(cat << 'SKILLEOF'
---
...
install_skill 'ui-ux-pro-max' "$(cat << 'SKILLEOF'
---
name: ui-ux-pro-max
