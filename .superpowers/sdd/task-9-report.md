...
- `npx vitest run src/services/__tests__/agencyDepartureReport.test.ts src/components/voyages/__tests__/VoyageAgencyReportTab.test.tsx` — 2 arquivos / 6 testes passaram.
