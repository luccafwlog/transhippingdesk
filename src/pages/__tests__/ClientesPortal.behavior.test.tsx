...
const row = {
  ...
  hasOpenInvoice: false, hasActiveProcess: false, lastActivityAt: null, candidates: [], sharedEmailCount: 0, latestDeliveryStatus: null, exceptionReason: null, recoveryEmailStatus: 'ok', recoveryEmailSuppressed: false,
} as const
