...
vi.mock('../../components/billing/DemurrageInvoicesSection', () => ({ DemurrageInvoicesSection: () => null }))
vi.mock('../../components/billing/PendenciasFaturamentoTab', () => ({ PendenciasFaturamentoTab: () => null }))
