...
const sql = readFileSync(
  resolve(__dirname, '../../../supabase/migrations/352_normalize_port_code_and_baplie_alerts.sql'),
  'utf-8',
)

describe('migration 352 — normalização de códigos de porto em SQL e reconciliação Baplie/BL', () => {
