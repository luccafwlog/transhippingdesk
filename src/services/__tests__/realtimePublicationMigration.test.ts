...
describe('migration 288 — orphan realtime publication', () => {
  it('drops only the unused publication member and is idempotent', () => {
    const sql = readFileSync(resolve(process.cwd(), 'supabase/migrations/288_drop_orphan_realtime_publication.sql'), 'utf8')
