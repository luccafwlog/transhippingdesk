...
describe('valorSugerido', () => {
  const local = { id: 'd1' }
  const generic = { id: 's1', depot_id: 'd1', name: 'handling in', rate_brl: 10, active: true, container_type: null, route_destino_id: null, condition: null }
  const specific = { ...generic, id: 's2', rate_brl: 25, container_type: '40HC', route_destino_id: 'd2', condition: 'material' }
