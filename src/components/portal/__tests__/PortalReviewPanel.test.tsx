...
const row: QueueRow = {
  ...
  candidates: [{ email: 'financeiro@example.com', purpose: 'financeiro', origin: 'Contato do Cliente' }], sharedEmailCnpjs: [], sharedEmailCount: 0, latestDeliveryStatus: null, exceptionReason: null,
}
