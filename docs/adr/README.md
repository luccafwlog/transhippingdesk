...
| [0031](./0031-vazios-exp-grao-container-cadastro-depot-tarifas.md) | VAZIOS EXP: grão-container substitui booking; Cadastro de Depot é a fonte de tarifas | aceito | Supersede a modelagem original do módulo Vazios (migration 035) quanto à identidade/unicidade; estende a 0027/0029 (Operação de Pátio exibe valores) e a 0004 (RBAC de Equipamentos); implementado nas migrations 229–233; supersedida parcialmente pela 0032 quanto ao modelo de tarifas do Cadastro de Depot |
| [0032](./0032-cadastro-depot-servicos-precificados-por-tipo-de-calculo.md) | Cadastro de Depot: serviços precificados por tipo de cálculo substituem tarifas estruturadas | aceito | Supersede parcialmente a 0031 (modelo de tarifas: serviços por tipo de cálculo, overtime por coluna importada, flags removidas); grão-container e upsert da 0031 permanecem; página renomeada `/embarquevazios/depots` fora do menu |
| [0033](./0033-notificacao-interna-separada-do-alerta-sino-entrega-alertas-trata.md) | Notificação Interna é conceito separado do Alerta: o sino entrega, `/alertas` trata | aceito | Estende a 0004 (RLS por destinatário) e a 0003; `/alertas` e o ciclo de vida do Alerta permanecem; não supersede a 0029/0030 quanto aos alertas de seção do ADR |
