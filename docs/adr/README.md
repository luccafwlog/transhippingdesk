...
| [0005](./0005-pipeline-importacao-viagem-staging-reconciliacao.md) | Pipeline de importação, staging e reconciliação | aceito | Supersedida parcialmente pela 0020 quanto ao billing dentro da transação de import |
...
| [0017](./0017-bl-fonte-ingestao-correcao-autoridade-compartilhada.md) | B/L como fonte de ingestão/correção; autoridade compartilhada com o manifesto | aceito | Estende a 0005 e a 0006; nota editorial 2026-07-01 eleva o B/L a fonte co-primária e exige viagem declarada; supersedida parcialmente pela 0020 quanto ao cálculo/emissão pós-commit |
...
| [0023](./0023-cancelamento-viagem-estado-retido-exclusao-hard-delete.md) | Cancelamento de viagem é estado retido; exclusão é hard delete | aceito | Complementa a ADR 0009 para viagens |
