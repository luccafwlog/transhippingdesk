...
- **Portal (push/armazenado):** [`src/services/portalBilling.ts`](../../src/services/portalBilling.ts)
  ...
  via [`159_portal_demurrage_reference.sql`](../../supabase/migrations/159_portal_demurrage_reference.sql)).
...
- `calculateDemurrage` rejeita devolução anterior à descarga; o modal repete a
  validação e
  [`089_demurrage_date_order_constraints.sql`](../../supabase/migrations/089_demurrage_date_order_constraints.sql)
...
- `mark_overdue_invoices()` foi reduzida em
  [`157_demurrage_drop_overdue.sql`](../../supabase/migrations/157_demurrage_drop_overdue.sql)
