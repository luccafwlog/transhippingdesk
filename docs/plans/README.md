...
- [2026-09-12 — Transição de marca: Transhipping Desk → Vela](2026-09-12-plano-transicao-marca-vela.md) — estudo e plano de renomeação do sistema interno para Vela e migração do domínio para `vela.app.br`; não inclui o Portal do Cliente (FWLog) nem a identidade financeira (Transhipping), que permanecem.
