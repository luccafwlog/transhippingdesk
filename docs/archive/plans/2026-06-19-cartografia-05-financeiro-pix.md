...
> **✅ Completed (2026-06-24).** `docs/modules/taxas-locais.md`, `docs/modules/faturamento.md`, and `docs/modules/reconciliacao-pix.md` mapped with standard contract, action catalogs, and evidence labels.
