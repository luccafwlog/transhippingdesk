...
| 23 | `023_customer_commercial_rules.sql` | ✅ OK | col+: commercial_notes, discount_pct, payment_terms_days | campos sem UI, removidos por `207_drop_customer_commercial_fields.sql` |
