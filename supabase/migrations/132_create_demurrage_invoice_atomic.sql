-- Renumbered from 20260622132732 (original timestamped migration: 20260622132732_create_demurrage_invoice_atomic.sql).
-- Create the Demurrage invoice document and its container snapshot atomically.
-- Rollback: drop public.create_demurrage_invoice_with_items and deploy the
-- previous frontend only after confirming no caller depends on this RPC.
