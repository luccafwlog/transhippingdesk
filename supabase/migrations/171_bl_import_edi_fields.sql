-- 171_bl_import_edi_fields.sql
-- #321 e fluxo EDI Mercante: o import de B/L persiste campos comerciais
-- parseados do Excel COSCO (total_packages, packages_unit, consignee_phone)
-- alem dos blocos de partes e cargo_description ja aceitos pela 166. Colunas ja
