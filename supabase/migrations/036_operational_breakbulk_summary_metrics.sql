-- 036: completa o resumo paginado de B/Ls com métricas de carga solta.
--
-- CargaSolta precisa totalizar máquinas, volumes, peso e CBM do conjunto
-- filtrado, mas não precisa materializar todos os B/Ls no browser. A assinatura
-- permanece a mesma para não quebrar Manifestos; somente o envelope JSON ganha
-- campos adicionais.
