-- 198: Repara lacunas da fila do Portal antes da leitura do console.
-- Não cria Auth, convite, email de recuperação ou email transacional.
...
BEGIN
  ...
  SELECT
    ...
    'Reparo automático da fila do Portal durante a leitura.', NULL
  FROM inserted;
...
REVOKE ALL ON FUNCTION public.portal_repair_missing_accounts()
