-- F-16: rate limiting em import_manifest_transactional.
--
-- Maximo 5 importacoes por usuario por janela de 60 segundos.
-- Exceede o limite → SQLSTATE P0429 (Too Many Requests).
-- O cliente mapeia P0429 para RateLimitImportError e exibe
-- mensagem amigavel sem expor o stack trace.
...
BEGIN
  -- F-16: rate limit — maximo 5 importacoes por usuario nos ultimos 60 segundos
