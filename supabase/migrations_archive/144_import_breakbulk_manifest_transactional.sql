-- Renumbered from 20260623095500 (original timestamped migration: 20260623095500_import_breakbulk_manifest_transactional.sql).
...
BEGIN
  ...
  SET
    ce_mercante = NULLIF(source.row->>'ce_mercante', ''),
