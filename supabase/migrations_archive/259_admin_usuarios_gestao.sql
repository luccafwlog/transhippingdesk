-- Administração de usuários internos: listagem protegida e auditoria de perfil.
-- Reconcilia o contrato já aplicado remotamente pela versão timestamp 20260805205139.
